...
var csts = {
  ...
  KEYMETRICS_ROOT_URL    : process.env.KEYMETRICS_NODE || config.KEYMETRICS_NODE,
  KEYMETRICS_BANNER      : '../lib/keymetrics',
  DEFAULT_MODULE_JSON    : config.DEFAULT_MODULE_JSON || 'package.json',

  REMOTE_PORT_TCP        : config.REMOTE_PORT_TCP || 80,
  REMOTE_PORT            : config.REMOTE_PORT || 41624,
  REMOTE_REVERSE_PORT    : config.REMOTE_REVERSE_PORT || 43554,
  REMOTE_HOST            : config.REMOTE_HOST,
  SEND_INTERVAL          : config.SEND_INTERVAL || 1000
};
